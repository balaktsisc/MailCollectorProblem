(define (problem MailColProb_3)
    ...
    (:init
        ...
        (p_connected p15 p14) (p_connected p14 p15)
        ...
        (m_connected p8 p13 l3) (m_connected p13 p14 l3)
        (m_connected p14 p15 l3) (m_connected p15 p10 l3)
        (m_connected p10 p8 l3)
        
        ;Metro Stations
        (station p2) (station p3) (station p6) 
        (station p7) (station p8) (station p15)
    )
    ...
    (:goal 
        (and 
            ...
            (not (carries person1 m9))
            (not (carries person1 m10))
            (not (carries person2 m1))
            ...
            (not (carries person2 m9))
            (not (carries person2 m10))
            (not (carries person3 m1))
            (not (carries person3 m2))
            (not (carries person3 m3))
            (not (carries person3 m4))
            (not (carries person3 m5))
            (not (carries person3 m6))
            (not (carries person3 m7))
            (not (carries person3 m8))
            (not (carries person3 m9))
            (not (carries person3 m10))
            (not (has_mail p1 m1))
            (not (has_mail p1 m2))
            (not (has_mail p1 m3))
            (not (has_mail p1 m4))
